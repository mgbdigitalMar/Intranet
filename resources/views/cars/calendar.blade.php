@extends('layouts.app')
@section('title', 'Calendario - Vehículos')
...
<div class="page-header">
  <div>
    <h2 class="section-title">📅 Calendario de Vehículos</h2>
    <p class="section-subtitle">Visualiza ocupación de vehículos por fecha (rojo=confirmado, naranja=pendiente)</p>
  </div>
  <div class="page-header-actions">
    <a href="{{ route('cars.index') }}" class="btn btn-ghost">← Lista</a>
  </div>
</div>
